<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="Agente_Vista.aspx.cs" Inherits="ExamenFinal.CapaPresentacion.Agente_Vista" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="gridViewAgentes" runat="server" AutoGenerateColumns="True">
            </asp:GridView>
        </div>
        ...
        <script>
            function agregarCliente() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/CapaPresentacion/Agente_Vista.aspx/AgregarCliente",
            ...
            function borrarCliente() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/CapaPresentacion/Agente_Vista.aspx/EliminarCliente",
            ...
            function modificarCliente() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/CapaPresentacion/Agente_Vista.aspx/ModificarCliente",
